...
# Additional mime types that are not known by the `mimetypes` module. They are
# registered on app startup and map a mime type to its file extensions, e.g.
# `text/plain=.ili,.itf;application/vnd.ms-outlook=.msg`
