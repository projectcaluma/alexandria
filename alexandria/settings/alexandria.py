...
# Celery queues
ALEXANDRIA_DEFAULT_CELERY_QUEUE = env.str(
    "ALEXANDRIA_DEFAULT_CELERY_QUEUE", default="celery"
)
ALEXANDRIA_CHECKSUM_CELERY_QUEUE = env.str(
    "ALEXANDRIA_CHECKSUM_CELERY_QUEUE", default=ALEXANDRIA_DEFAULT_CELERY_QUEUE
)
ALEXANDRIA_THUMBNAIL_CELERY_QUEUE = env.str(
    "ALEXANDRIA_THUMBNAIL_CELERY_QUEUE", default=ALEXANDRIA_DEFAULT_CELERY_QUEUE
)
ALEXANDRIA_CONTENT_SEARCH_CELERY_QUEUE = env.str(
    "ALEXANDRIA_CONTENT_SEARCH_CELERY_QUEUE", default=ALEXANDRIA_DEFAULT_CELERY_QUEUE
)

# Tika
TIKA_SERVER_URL = env.str("TIKA_SERVER_URL", default="http://tika:9998")
